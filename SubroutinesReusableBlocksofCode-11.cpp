...
int main() {
    int number1,number2;
    char amalgar = '+';
    cout << "2 adad ra vared konid va yeki az amalgar haye +,-,*,/ ra ham vared konid(agar amamlgar vared nemikhahid koned enter bezanid ke be soorat pishfarz emal beshe):" << endl;
    cin >> number1 >> number2;
